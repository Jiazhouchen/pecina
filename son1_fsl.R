...
####BE AWARE!
argu<-as.environment(list(nprocess=10,onlyrun=c(1,2),forcereg=TRUE,cfgpath="/Volumes/bek/autopreprocessing_pipeline/Neurofeedback/nfb.cfg",
                          regpath="/Volumes/bek/neurofeedback/sonrisa1/nfb/regs/R_fsl_reg",func.nii.name="nfswudktm*[0-9]_[0-9].nii.gz",
                          proc_id_subs="_a",regtype=".1D", convlv_nuisa=FALSE,adaptive_gfeat=TRUE,

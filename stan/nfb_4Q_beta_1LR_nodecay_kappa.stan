      ...
      if(nTrial[s,se]!=0){
        ...
        for (t in 1:nTrial[s,se]){
          ...
          if(missing_choice_exp[s,se,t]==0){
            ...
            choice ~ bernoulli_logit( ((Q[s,se,t,Infusion_f[s,se,t]]+ kappa[s,se])  * beta[s,se]) + (pers[s,se]*prev_choice) );
      ...
      if(nTrial[s,se]!=0){
        ...
        for (t in 1:maxTrialN){
          ...
          if(missing_choice_exp[s,se,t]==0){
            ...
            //choice yes or no
            choice = ExpRat[s,se,t]==1;
            log_lik[s,se,t] = bernoulli_logit_lpmf(choice | ((Q[s,se,t,Infusion_f[s,se,t]]+ kappa[s,se])  * beta[s,se]) + (pers[s,se]*prev_choice) );
            prev_choice = choice? 1:-1 ; //1 if choice NO, -1 if choice YED
